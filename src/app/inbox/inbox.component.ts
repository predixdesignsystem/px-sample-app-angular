...
export class InboxComponent {
  ...
  updateInboxDetails(e) {
    ...
    this.title = inboxItem.title;
    this.severity = inboxItem.severity;
    this.alertId = inboxItem.alertId;
    this.alertSource = inboxItem.alertSource;
    this.receivedDateTime = inboxItem.receivedDateTime;
    this.caseNumber = inboxItem.caseNumber;
    this.customer = inboxItem.customer;
    this.serialNumber = inboxItem.serialNumber;
    this.dlnType = inboxItem.dlnType;
    this.model = inboxItem.model;
  }
